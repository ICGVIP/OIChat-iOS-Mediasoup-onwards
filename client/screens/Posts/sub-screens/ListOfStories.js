...
import {Text,SafeAreaView,FlatList, StyleSheet,View,Image, ScrollView, TouchableOpacity, Keyboard, useColorScheme, StatusBar, Dimensions, Pressable, TextInput, KeyboardAvoidingView, Platform} from 'react-native';
...
export const ListofStories = ({navigation, route}) => {
    ...
    console.log(stories,storyIndex,'...inside listofstories...\n\n')
          ...
          <View style={styles.header}>
            ...
            <View style={styles.indicatorRow}>
              {stories.map((story, index) => (
                <View key={`${story.id}-${index}`} style={styles.indicatorBG}>
                  <Animated.View
                    style={[
                      styles.indicator,
